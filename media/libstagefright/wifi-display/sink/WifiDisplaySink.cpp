...
void WifiDisplaySink::onGetParameterRequest(
    ...
    if (mRTPSink == NULL) {
	mRTPSink = new RTPSink(mNetSession, mSurfaceTex,mNotifyStop);
    ...
    snprintf(body, sizeof(body), 
        ...
        "wfd_video_formats: 28 00 02 02 %s %s %s 00 0000 0000 11 none none, 01 02 %s %s %s 00 0000 0000 11 none none\r\n" //native prefer_display_mode h264_profile h264_level CEA VESA HH latency min_slice slice_enc frame_control -1280p30p
