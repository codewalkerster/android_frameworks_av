...
static const struct {
    ...
    { "OMX.google.flac.decoder", "amsoftadec", "audio_decoder.flac" },
    { "OMX.google.alac.decoder", "alacdec", "audio_decoder.alac" },
    { "OMX.google.wma.decoder", "wmadec", "audio_decoder.wma" },
    { "OMX.google.wmapro.decoder", "wmaprodec", "audio_decoder.wmapro" },
    { "AML.google.ac3.decoder", "dcvdec", "audio_decoder.ac3" },
    { "AML.google.ec3.decoder", "dcvdec", "audio_decoder.ec3" },
    { "AML.google.dtshd.decoder", "dtshd", "audio_decoder.dtshd"},
    { "OMX.google.alac.decoder", "alacdec", "audio_decoder.alac" },
    { "OMX.google.ape.decoder", "apedec", "audio_decoder.ape" },
